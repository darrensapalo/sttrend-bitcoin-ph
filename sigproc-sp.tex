...
% 3rd. author
\and
\alignauthor Marvin T. Suangco\\
       \affaddr{De La Salle University}\\
       \email{marvin\_{}suangco@dlsu.edu.ph}
  % use '\and' if you need 'another row' of author names
% 4th. author
\alignauthor
\alignauthor Daniel Joseph G. Tan\\
       \affaddr{De La Salle University}\\
       \email{daniel\_{}tan@dlsu.edu.ph}
}
...
% Some how segway or transition to focusing on markerless finger tracking 
This research paper studies different approaches in markerless finger tracking.

% Discuss Art of Defense, a tile-based AR tower-defense game played on the mobile
...
\begin{figure}[!ht]
\centering
\includegraphics[width=2.5in]{sample_dataset_instance}
